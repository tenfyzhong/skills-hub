...
| IDX-001 | FULLTEXT inside CREATE TABLE | Capability difference for self-managed 8.5; Cloud requires profile and explicit capability evidence, not guesses from the plan name |
