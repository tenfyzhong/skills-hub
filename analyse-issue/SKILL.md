---
name: analyse-issue
description: Analyze GitHub issues by link or issue number. Use when a user says "analyse issue"/"analyze issue"/"分析 issue" or provides a GitHub issue URL/number and asks to fetch the issue content, verify it matches the current repo, and inspect local code to confirm the problem.
---
