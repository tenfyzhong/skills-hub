...
- mysql-to-tidb-ddl-check - assess exported MySQL DDL for TiDB 8.5 and TiDB Cloud, with English, Chinese, or Japanese reports containing located findings, coverage gaps, and remediation advice
